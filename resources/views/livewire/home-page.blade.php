<div>
    {{-- Hero section start --}}
    <div class="w-full h-screen bg-gradient-to-b from-gray-100 via-gray-300 to-gray-400 py-10 px-4 sm:px-6 lg:px-8 mx-auto mt-12">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Alphalva</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Temukan beragam pilihan tas kamera terbaik untuk mendukung setiap momen fotografimu.</p>
              ...
              <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                ...
                <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="https://wa.me/6285882868240" target="_blank" rel="noopener">
                  Contact sales team
                </a>
              </div>
              <!-- End Buttons -->
            ...
            <div class="relative ms-4">
              <img class="w-full rounded-md" src="{{ asset('images/barang baru.svg') }}" alt="Image Description">
    ...
    <section class="py-14 font-poppins bg-gradient-to-b from-gray-300 via-gray-500 to-gray-700">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold dark:text-gray-200"> Customer <span class="text--black"> Reviews
                  </span> </h1>
              </div>
              <p class="mb-12 text-base text-center text-gray-100 mt-4">
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
            ...
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                Alphalva benar-benar membantu saya mendapatkan perlengkapan fotografi terbaik. Rekomendasi untuk semua fotografer!
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
