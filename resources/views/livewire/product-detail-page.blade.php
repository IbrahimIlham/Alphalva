<div>
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto mt-12">
                ...
                <div class="sticky top-0 z-10 overflow-hidden ">
                  ...
                  <div class="flex-wrap hidden md:flex ">
                     ...
                     <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ url('storage', $image) }}'">
                       <img src="{{ url('storage', $image) }}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                     </div>
                     @endforeach
                ...
                <div class="lg:pl-20">
                  <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4 ">
                    ...
                    <p class="max-w-md text-gray-700 dark:text-gray-400">
                      {!! isset($product) && $product->description ? Str::markdown($product->description) : '' !!}
                    </p>
                  </div>
                  <div class="w-32 mb-8 ">
                    ...
                    <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                      <button wire:click="decrementQty" class="w-20 h-full text-gray-600 bg-gray-300 rounded-l outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 hover:text-gray-700 dark:bg-gray-900 hover:bg-gray-400">
                      ...
                      <button  wire:click="incrementQty" class="w-20 h-full text-gray-600 bg-gray-300 rounded-r outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 dark:bg-gray-900 hover:text-gray-700 hover:bg-gray-400">
                        <span class="m-auto text-2xl font-thin">+</span>
                      </button>
                    </div>
                  </div>
